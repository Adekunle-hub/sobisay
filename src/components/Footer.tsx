        ...
        <div className=" mx-auto w-[90%]  ">
          <footer className="pb-[3rem] flex flex-col md:flex-row justify-between">
            <div className="fex flex-col w-full md:w-[22rem] ">
              ...
              <p className="text-sm py-[1rem]">
                {" "}
                Sobisay Studio is a global platform dedicated to providing the
                best solutions for our customers in managing their operations.
              </p>
            ...
            <article className="flex flex-row md:gap-[4rem] pt-[1rem] justify-between">
              <div className="flex flex-col gap-[1rem]">
                <h1 className="md:text-xl text-base flex items-center gap-1 ">
                  {" "}
                  Services
                  <span>
                    {" "}
              ...
              <div className="flex flex-col gap-[1rem]">
                ...
                <a href="#Contact Us" className="text-xs md:text-sm">
                  Contact Us
                </a>
              </div>
            </article>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-2 pt-[1.4rem]">
                ...
                <div className="flex bg-white justify-between px-[1rem] py-[0.5rem] rounded-3xl">
                  ...
                  />
                  <button className="bg-[#024866] py-1 text-white text-xs px-3 md:scale-[0.8] rounded-2xl">
                    Submit
                  </button>
                </div>
              </div>
          ...
          <div className="flex w-[100%] md:items-start md:justify-start items-center justify-center border-t-1 text-[#9B9B9B] mx-auto py-[2rem]">
            ...
            <p>All right reserved by Sobisay Studio</p>
          </div>
        </div>
      </MaxContainer>
    </section>
